        ...
        <div className="w-1/2 h-1/2 bg-white shadow-lg rounded-lg flex overflow-hidden">
          ...
          <div className="w-1/2 flex flex-col justify-center items-center p-8">
            <div className="w-full max-w-md">
              <h2 className="text-2xl font-bold mb-2 text-center text-blue-600">Get Started!</h2>
              <h4 className="text-1xl mb-6 text-center text-blue-600">Please Fill your Signup Details Below</h4>
              <form>
                <div className="mb-4">
                  <input 
                    type="text" 
              ...
              <div className="text-center mt-4">
                If you are an employee? <Link to="/login" className="text-green-500 hover:underline">Login</Link>
              </div>
            </div>
          </div>
        </div>
